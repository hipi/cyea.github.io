...
cover: https://s2.ax1x.com/2019/10/24/KUQM0f.jpg
---
...
![](https://s2.ax1x.com/2019/10/24/KUKjMt.jpg)
```js
var Person = function (name) { this.name = name; }//person是构造函数
var o3personTwo = new Person('personTwo')//personTwo是实例
```

![](https://s2.ax1x.com/2019/10/24/KUKvsP.jpg)<br />原型对象都有一个默认的constructor属性指向构造函数
...
### 1.6.5 对象的原型链
![](https://s2.ax1x.com/2019/10/24/KUKxqf.jpg)
...
Array.flat(n)是ES10扁平数组的api,n表示维度,n值为Infinity时维度为无限大<br />2.开始篇
```js
...
### 7.5.9 浏览器请求分析
![](https://s2.ax1x.com/2019/10/24/KUMSZ8.jpg)
